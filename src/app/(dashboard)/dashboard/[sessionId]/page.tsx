...
const page = async(props: { params: { sessionId: string } }) => {
   ...
   await generateMultipleChoiceQuestions({assessment:assessment[0],content:sessionData[0]!.description!,questionsCount:sessionData[0].questionCount,versionId:version[0].id,duration:sessionData[0].duration,type:sessionData[0].generateBy,url:sessionData[0].url!})
